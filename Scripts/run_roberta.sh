...
python -m torch.distributed.launch --nproc_per_node=4 main_large.py \
    --model_type roberta \
    ...
    --output_dir ../Checkpoints/reclor/roberta_base \
    --logging_steps 200 \
    --save_steps 200 \
    --adam_betas "(0.9, 0.98)" \
    --adam_epsilon 1e-6 \
...
#    --learning_rate 1e-5 \
#    --num_train_epochs 10.0 \
#    --output_dir ../Checkpoints/reclor/roberta_extension \
#    --logging_steps 200 \
#    --save_steps 200 \
#    --adam_betas "(0.9, 0.98)" \
#    --adam_epsilon 1e-6 \
...
#    --learning_rate 1e-5 \
#    --num_train_epochs 10.0 \
#    --output_dir ../Checkpoints/reclor/roberta_augmentation \
#    --logging_steps 200 \
#    --save_steps 200 \
#    --adam_betas "(0.9, 0.98)" \
#    --adam_epsilon 1e-6 \
